...
import { createCourse, updateCourse } from './store/actions'
// ----------------------------------------------------------------------
  ...
  return (
    <>
      <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
         {!sectionOpen ?(
          <>
         <Typography variant="h4" gutterBottom sx={{ marginTop: "60px" ,marginLeft:'150px'}}>Create Course</Typography>
        ...
        <Grid item xs={12} md={1}>{}</Grid>
          <Grid item xs={12} md={7}>
            <Card sx={{ p: 3 }}>
              ...
              <Stack alignItems="flex-end" sx={{ mt: 3 ,marginRight:'70px'}}>
