...
//
import { createLecture } from './store/actions'
...
export default function Lecture({ section, type }) {
                            ...
                            <Card sx={{ p: 3 }}>
                                <Stack spacing={3}>
                                    ...
                                    <Grid container>
                                        ...
                                        <Grid item xs={12} md={8} >
                                            <RHFTextField name="body" multiline rows={3} size="small" onChange={(e) => handleBody(e)} />
                                        </Grid>
                                    </Grid>
