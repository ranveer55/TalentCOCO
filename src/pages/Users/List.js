...
// sections
import { UserTableRow, UserTableToolbar } from '../../sections/@dashboard/users/user-list';
...
export default function List() {
  ...
  const RemoveRow = () => {
    ...
    if (deleteId) {
      ...
      dispatch(deleteUser(selectDeleteId));
  ...
  const handleEditRow = (id) => {
    navigate(PATH_DASHBOARD.users.edit(paramCase(id)));
  };
  const handleViewRow = (id) => {
    navigate(PATH_DASHBOARD.users.view(paramCase(id)));
 };
                        ...
                        <Dialog
                            ...
                            <DialogContent>
                                <DialogContentText id="alert-dialog-description">
                                    Are you sure you want to delete the User?</DialogContentText>
                            </DialogContent>
                            <DialogActions>
