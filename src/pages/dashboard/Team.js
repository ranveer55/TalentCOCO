...
// sections
import {TeamTableRow,TeamTableToolbar} from '../../sections/@dashboard/team/team-list';
...
export default function Team() {
  ...
  const handleEditRow = (id) => {
     navigate(PATH_DASHBOARD.teams.edit(paramCase(id)));
  };
  const handleViewRow = (id) => {
    navigate(PATH_DASHBOARD.teams.view(paramCase(id)));
 };
  ...
  return (
    <Page title="Items: Team List">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <Card>
          <TeamTableToolbar filterName={filterName} onFilterName={handleFilterName} />
                    ...
                    .map((row, index) =>
                      row ? (
                        <TeamTableRow
                          ...
                          onEditRow={() => handleEditRow(row.title)}
