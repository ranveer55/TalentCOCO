...
export default function CourseDetailsReviewOverview({ course, onOpen }) {
      ...
      <GridStyle course xs={12} md={4}>
        <Stack spacing={1.5} sx={{ width: 1 }}>
          {ratings
            ...
            .reverse()
            .map((rating) => (
              <ProgressCourse key={rating.name} star={rating} total={total} />
            ))}
        </Stack>
      </GridStyle>
...
function ProgressCourse({ star, total }) {
