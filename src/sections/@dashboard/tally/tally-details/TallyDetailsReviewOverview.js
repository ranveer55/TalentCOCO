...
TallyDetailsReviewOverview.propTypes = {
  item: PropTypes.object,
  onOpen: PropTypes.func,
};

export default function TallyDetailsReviewOverview({ item, onOpen }) {
...
ProgressTally.propTypes = {
  star: PropTypes.object,
  total: PropTypes.number,
};

function ProgressTally({ star, total }) {
