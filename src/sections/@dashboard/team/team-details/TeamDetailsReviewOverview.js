...
TeamDetailsReviewOverview.propTypes = {
  item: PropTypes.object,
  onOpen: PropTypes.func,
};

export default function TeamDetailsReviewOverview({ item, onOpen }) {
...
ProgressTeam.propTypes = {
  star: PropTypes.object,
  total: PropTypes.number,
};

function ProgressTeam({ star, total }) {
